  ...
  <div class="container">
    ...
    <div class="collapse navbar-collapse text-right" id="navbarText">
      <ul class="navbar-nav ms-auto mb-2 mb-lg-0">
        ...
        <li class="nav-item">
          <a class="nav-link active" href="barang_keluar.php"><b>Barang Keluar</b></a>
        </li>
        <li class="nav-item">
...
<div class="container">
	...
	<div class="card mt-5">
	  <div class="card-header bg-dark text-white">
	    <p class="text-center">Penambahan Data Barang Keluar</p>
	  </div>
	  <div class="card-body">
	    <form method="post" action="">
	    	...
	    	<div class="form-group">
	    		...
	    		<input type="date" name="ttanggal_keluar" value="<?=@$vtglkeluar?>" class="form-control" required>
	    	</div>
	    	<br>
	...
	<div class="card mt-3">
	  <div class="card-header bg-dark text-white">
	    <p class="text-center">Data Barang Keluar</p>
	  </div>
	  <div class="card-body">
	    ...
	    <table class="table table-bordered table-striped">
	    	...
	    	<?php
	    		$no = 1;
	    		$tampil = mysqli_query($koneksi, "SELECT * from barang_keluar order by id_barang_keluar desc");
	    	...
	    	<tr>
	    		...
	    		<td>
	    			<a href="barang_keluar.php?hal=edit&id=<?=$data['id_barang_keluar']?>" class="btn btn-warning"> Edit </a>
	    			<a href="barang_keluar.php?hal=hapus&id=<?=$data['id_barang_keluar']?>" 
